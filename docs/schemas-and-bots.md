...
대시보드 운영자는 `GET /dashboard/schemas` 엔드포인트와 dispatch 모달의 스키마
dropdown으로 등록된 스키마를 조회·선택할 수 있다 — JSONEditor가 선택된 스키마로
payload 폼을 자동 생성한다 (자세한 흐름: [`docs/dashboard.md`](dashboard.md)).
