...
**Debugger note:** use it only for breadth of evidence (parallel instrumentation, multi-hypothesis sweep). It never overrides root-cause-first — the single surviving hypothesis is still investigated and verified sequentially.
